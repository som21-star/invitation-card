...
import marigoldGarlandOld from '@/assets/marigold-garland.png';
...
import { BetelLeaf, Mukut, Topor, Dhunuchi, GreenDoor } from './TraditionalElements';

const WeddingCardAutoScrollGroom = () => {
        ...
        >
            ...
            >
                ...
                <div className="w-full h-full flex-shrink-0 flex flex-col items-center justify-center px-6 py-8 relative" style={{ width: `${100 / totalSlides}%` }}>
                    <div className="absolute left-4 top-10 w-14 h-auto animate-float z-30">
                    ...
                    <div className="text-center mb-4">
                        <p className="font-bengali text-[#FFD700] text-lg drop-shadow-lg">॥ শ্রী শ্রী প্রজাপতয়ে নমঃ ॥</p>
                    </div>
                ...
                {/* Section 2: Groom & Bride (পাত্র ও পাত্রী) */}
                <div className="w-full h-full flex-shrink-0 flex flex-col items-center justify-center px-6 py-8 relative" style={{ width: `${100 / totalSlides}%` }}>
                    <div className="absolute -top-4 left-0 right-0 w-full z-0">
                        <img src={flowerGarland2} alt="" className="w-full h-auto" />
                    </div>
                    ...
                    <div className="text-center w-full max-w-xs mb-3">
                        <div className="bg-black/20 backdrop-blur-sm rounded-lg px-4 py-3 border border-[#FFD700]/40">
                            ...
                            <p className="font-bengali text-[#FFEAA7] text-xs">নিবাস: পানাগড় গ্রাম, পশ্চিম বর্ধমান</p>
                        </div>
                    </div>
                    ...
                    <div className="text-center w-full max-w-xs">
                        <div className="bg-black/20 backdrop-blur-sm rounded-lg px-4 py-3 border border-[#FFD700]/40">
                            ...
                            <p className="font-bengali text-[#FFEAA7] text-xs">নিবাস: কাঁকসা গাঙ্গুলী পাড়া, পানাগড়</p>
                        </div>
                    </div>
                </div>

                {/* Section 3: Reception (Replaces Gaye Holud) */}
                <div className="w-full h-full flex-shrink-0 flex flex-col items-center justify-center px-6 py-8 relative" style={{ width: `${100 / totalSlides}%` }}>
                    ...
                    <div className="mb-4 bg-[#6B1B1B] rounded-lg p-2">
                         <GreenDoor className="w-24 h-32 mx-auto animate-pulse-glow text-[#FFD700]" />
                    </div>

                    <div className="bg-black/20 backdrop-blur-sm rounded-xl px-8 py-6 border-2 border-[#FFA500]/50 text-center max-w-sm">
                        <h3 className="font-bengali-display text-[#FFA500] text-2xl font-bold mb-0">
                            প্রীতিভোজ
                        </h3>
                         <h3 className="font-bengali-display text-[#FFA500] text-lg font-bold mb-4">
                            (রিসেপশন)
                        </h3>
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="font-bengali text-[#FFA500] text-base font-medium">
                             ...
                             <div className="mt-4 pt-4 border-t border-[#FFD700]/30">
                                <p className="font-bengali text-[#FFEAA7] text-sm mb-1">স্থান</p>
                                <p className="font-bengali text-[#FFD700] text-base font-semibold leading-relaxed">
                                    মা মৌলিক্সা অনুষ্ঠান ভবন
                                </p>
                                <p className="font-bengali text-[#FFEAA7] text-sm">
                                    মারগ্রাম রোড, রামপুরহাট, বীরভূম
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="relative z-10 flex flex-col items-center mt-4">
                        <div className="text-center mb-3">
                            ...
                            <p className="font-bengali text-[#FFD700] text-base font-semibold">নিজ বাসভবন</p>
                             <p className="font-bengali text-[#FFEAA7] text-xs line-clamp-2 px-6">
                                পানাগড় গ্রাম, পশ্চিম বর্ধমান
                            </p>
                        </div>
                ...
                <div className="w-full h-full flex-shrink-0 flex flex-col items-center justify-center px-6 py-8 relative" style={{ width: `${100 / totalSlides}%` }}>
                    ...
                    <div className="bg-black/20 backdrop-blur-sm rounded-xl px-6 py-6 border-2 border-[#FFD700]/40 text-center max-w-sm">
                        ...
                        <p className="text-[#FFEAA7] text-sm leading-relaxed mb-4">
                            Mr. Ram Narayan Kesh and Mrs. Sujata Kesh cordially request
                            the pleasure of your gracious presence and blessing on the auspicious occasion of the wedding of their beloved son,
                        </p>

                        <div className="my-4">
                            <h2 className="text-[#FFD700] text-2xl font-bold mb-2">Sourav</h2>
                            <p className="text-[#FFD700] text-lg mb-2">weds</p>
                            <h2 className="text-[#FFD700] text-2xl font-bold">Shatabdi</h2>
                        </div>
                        ...
                        <p className="text-[#FFD700] text-sm font-semibold mb-3">
                            Date of the Event: Friday, 6th February, 2026
                        </p>

                        <p className="text-[#FFEAA7] text-xs leading-relaxed mb-3">
                            Address: Panagarh Gram, Paschim Bardhaman, 713148
                        </p>

                        <p className="text-[#FFEAA7]/80 text-xs italic">
                            Sandhya Rani Kesh (Thakuma)
                        </p>
                    </div>
                </div>
                ...
                <div className="w-full h-full flex-shrink-0 flex flex-col items-center justify-center px-6 py-8 relative" style={{ width: `${100 / totalSlides}%` }}>
                    <div className="absolute left-4 bottom-44 w-14 h-auto animate-float z-30">
                        <img src={kalashDecor} alt="" className="w-full h-auto" />
                    </div>
                    <div className="absolute right-4 bottom-44 w-14 h-auto animate-float z-30" style={{ animationDelay: '0.5s' }}>
                        <img src={kalashDecor} alt="" className="w-full h-auto -scale-x-100" />
                    </div>
                    ...
                    <div className="text-center mb-4">
                        <p className="font-bengali text-[#FFEAA7] text-sm italic leading-relaxed px-4">
                         ...
                         <p className="font-bengali text-[#FFD700] text-xs mt-2 font-bold">
                            বিনীত — শ্রী সৌরভ কেশ ও সমগ্র কেশ পরিবার
                        </p>
                    </div>
...
export default WeddingCardAutoScrollGroom;
